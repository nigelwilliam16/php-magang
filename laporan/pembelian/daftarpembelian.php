...
SUM(nota_beli_product.harga * nota_beli_product.quantity)AS total_pembelian, nota_beli.foto, nota_beli.id_cabang, 
cabang.nama_cabang, nota_beli.username, account.nama_depan, account.nama_belakang FROM nota_beli INNER JOIN nota_beli_product 
