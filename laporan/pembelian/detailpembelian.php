...
INNER JOIN account ON nota_beli.username = account.username WHERE nota_beli_product.id_nota_beli = ?";
...
if($result->num_rows > 0) {
  ...
  $sql2 = "SELECT nota_beli_product.id_product, product.jenis, nota_beli_product.quantity, nota_beli_product.total 
